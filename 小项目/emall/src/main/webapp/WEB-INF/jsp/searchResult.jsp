            ...
            <div class="product">
                <div class="product-iWrap">
                    <div class="productImg-wrap">
                        <a class="productImg" href="<%=request.getContextPath()%>/showProduct?product_id=${p.id}">
                    ...
                    <p class="productTitle">
                        <a href="<%=request.getContextPath()%>/showProduct?product_id=${p.id}">${p.title}</a>
                    </p>
                    <p class="productStatus">
                        <span>销量<em><%=new Random().nextInt(50000)%></em></span>
                        <span>评价<a href="#nowhere"><%=new Random().nextInt(40000)%></a></span>
