    ...
    <div class="bgh">
        <div class="page">
            ...
            <div class="topxx">
                ...
                管理员：${tec}，欢迎您！ <a href="#">我的信息</a> <a href="#">
                通知</a> <a href="#">密码修改</a> <a
                    href="${pageContext.request.contextPath}/authority/logout">安全退出</a>
            </div>
            <div class="blog_nav">
                <ul>
                    <li><a href="index.jsp">管理主页</a></li>
                    <li><a href="#">教务中心</a></li>
                    <li><a href="#">资料中心</a></li>
                </ul>
            </div>
    ...
    <div class="box mtop">
        <div class="leftbox">
            <div class="l_nav2">
                ...
                <div class="cdlist">
                    <div>
                        <a href="${pageContext.request.contextPath}/tec/stuInfo">学生管理</a></div>
                    <div>
                        <a href="${pageContext.request.contextPath}/tec/classInfo">班级管理 </a>
                    </div>
                    <div>
                        <a href="#">紧急信息</a></div>
                    <div>
                ...
                <div class="cdlist">
                    <div>
                        <a href="${pageContext.request.contextPath}/tec/courseInfo">课程管理</a></div>
                    <div>
                        <a href="${pageContext.request.contextPath}/tec/scoreInfo">成绩信息</a></div>
                </div>
